		...
		<>
			<div className="flex flex-col items-center justify-center h-screen">
				...
				<Link href={`/parciales/ICSE`}>
					<div className="mt-2 cursor-pointer bg-gray-800 hover:bg-gray-700 text-white py-2 px-4 rounded-lg transition duration-300 text-center">
						ICSE
					</div>
				</Link>
			</div>
