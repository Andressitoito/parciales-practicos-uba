...
import { allQuestionsData } from "./primer-cuatri/parciales.js";
		...
		<>
			...
			<div className="flex flex-col items-center">
							...
							{allQuestionsData.map((item) => (
								<div key={item.name} className="mb-4">
									<Link
										...
										href={{
											pathname: "/parciales/IPC/primer-cuatri",
										}}
				...
				>
					...
					{openIndex === 2 && <div>Proximamente...</div>
					...
					// 					className="cursor-pointer bg-gray-700 hover:bg-gray-500 text-white py-2 px-4 rounded-lg transition duration-300 text-center"
					// 					href={{
					// 						pathname: "/parciales/IPC/segundo-cuatri",
					// 					}}
					// 					onClick={() => handleButtonClick(item.name)}
					// 				>
					// 					{item.name}
				...
				>
					...
					{openIndex === 3 && <div>Proximamente...</div>
